...
static void initialize_c1_ClosedLoopSystem(SFc1_ClosedLoopSystemInstanceStruct
  *chartInstance);
static void initialize_params_c1_ClosedLoopSystem
  (SFc1_ClosedLoopSystemInstanceStruct *chartInstance);
static void enable_c1_ClosedLoopSystem(SFc1_ClosedLoopSystemInstanceStruct
  *chartInstance);
static void disable_c1_ClosedLoopSystem(SFc1_ClosedLoopSystemInstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_ClosedLoopSystem
  (SFc1_ClosedLoopSystemInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_ClosedLoopSystem
  (SFc1_ClosedLoopSystemInstanceStruct *chartInstance);
static void set_sim_state_c1_ClosedLoopSystem
  (SFc1_ClosedLoopSystemInstanceStruct *chartInstance, const mxArray *c1_st);
static void finalize_c1_ClosedLoopSystem(SFc1_ClosedLoopSystemInstanceStruct
  *chartInstance);
static void sf_gateway_c1_ClosedLoopSystem(SFc1_ClosedLoopSystemInstanceStruct
  *chartInstance);
static void initSimStructsc1_ClosedLoopSystem
  (SFc1_ClosedLoopSystemInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_ClosedLoopSystemInstanceStruct
  *chartInstance, const mxArray *c1_TbR, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_ClosedLoopSystemInstanceStruct
...
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_c_emlrt_marshallIn(SFc1_ClosedLoopSystemInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_d_emlrt_marshallIn(SFc1_ClosedLoopSystemInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  c1_snXp3ygPcVyeDzfVLtVbyQF *c1_y);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_e_emlrt_marshallIn(SFc1_ClosedLoopSystemInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_ClosedLoopSystem, const
  char_T *c1_identifier);
static uint8_T c1_f_emlrt_marshallIn(SFc1_ClosedLoopSystemInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_ClosedLoopSystemInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_ClosedLoopSystem = 0U;
}
  ...
  (SFc1_ClosedLoopSystemInstanceStruct *chartInstance)
{
  ...
  c1_c_hoistedGlobal = chartInstance->c1_is_active_c1_ClosedLoopSystem;
  ...
  (SFc1_ClosedLoopSystemInstanceStruct *chartInstance, const mxArray *c1_st)
{
  ...
  *c1_TbR = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
    "TbR");
  chartInstance->c1_is_active_c1_ClosedLoopSystem = c1_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 2)),
     "is_active_c1_ClosedLoopSystem");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_ClosedLoopSystem(chartInstance);
  ...
  *chartInstance)
{
  ...
  real_T c1_TbF;
  real_T c1_TbR;
  static c1_snXp3ygPcVyeDzfVLtVbyQF c1_r1 = { 1245.0, 1200.0, 1.8, 1.1, 1.3,
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_ClosedLoopSystemInstanceStruct *chartInstance;
  chartInstance = (SFc1_ClosedLoopSystemInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_ClosedLoopSystem_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c1_identifier)
{
  ...
  c1_y = c1_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_ClosedLoopSystem), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_ClosedLoopSystem);
  return c1_y;
}
...
void sf_c1_ClosedLoopSystem_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3619766653U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4254059777U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(944471221U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1024840764U);
}

mxArray *sf_c1_ClosedLoopSystem_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("ZUrZfZxdoCcKYhkg88qcoG");
...
mxArray *sf_c1_ClosedLoopSystem_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_ClosedLoopSystem_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_ClosedLoopSystem(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"TbF\",},{M[1],M[11],T\"TbR\",},{M[8],M[0],T\"is_active_c1_ClosedLoopSystem\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_ClosedLoopSystem_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_ClosedLoopSystemInstanceStruct *)
...
{
  return "WVRjnB7Zh4lSqwwpa6oEgF";
}

static void sf_opaque_initialize_c1_ClosedLoopSystem(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_ClosedLoopSystemInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_ClosedLoopSystem((SFc1_ClosedLoopSystemInstanceStruct*)
    chartInstanceVar);
  initialize_c1_ClosedLoopSystem((SFc1_ClosedLoopSystemInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_ClosedLoopSystem(void *chartInstanceVar)
{
  enable_c1_ClosedLoopSystem((SFc1_ClosedLoopSystemInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_ClosedLoopSystem(void *chartInstanceVar)
{
  disable_c1_ClosedLoopSystem((SFc1_ClosedLoopSystemInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_ClosedLoopSystem(void *chartInstanceVar)
{
  sf_gateway_c1_ClosedLoopSystem((SFc1_ClosedLoopSystemInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_ClosedLoopSystem(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_ClosedLoopSystem
    ((SFc1_ClosedLoopSystemInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_ClosedLoopSystem();/* state var info */
...
extern void sf_internal_set_sim_state_c1_ClosedLoopSystem(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_ClosedLoopSystem();/* state var info */
  ...
  set_sim_state_c1_ClosedLoopSystem((SFc1_ClosedLoopSystemInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_ClosedLoopSystem(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_ClosedLoopSystem(S);
}

static void sf_opaque_set_sim_state_c1_ClosedLoopSystem(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c1_ClosedLoopSystem(S, st);
}

static void sf_opaque_terminate_c1_ClosedLoopSystem(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_ClosedLoopSystemInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c1_ClosedLoopSystem((SFc1_ClosedLoopSystemInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_ClosedLoopSystem((SFc1_ClosedLoopSystemInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_ClosedLoopSystem(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_ClosedLoopSystem(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(413027178U));
  ssSetChecksum1(S,(1090382254U));
  ssSetChecksum2(S,(2802561947U));
  ssSetChecksum3(S,(223869147U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c1_ClosedLoopSystem(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_ClosedLoopSystem(SimStruct *S)
{
  SFc1_ClosedLoopSystemInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_ClosedLoopSystemInstanceStruct *)utMalloc(sizeof
    (SFc1_ClosedLoopSystemInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_ClosedLoopSystemInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_ClosedLoopSystem;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_ClosedLoopSystem;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_ClosedLoopSystem;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_ClosedLoopSystem;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_ClosedLoopSystem;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_ClosedLoopSystem;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_ClosedLoopSystem;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_ClosedLoopSystem;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_ClosedLoopSystem;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_ClosedLoopSystem;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_ClosedLoopSystem;
...
void c1_ClosedLoopSystem_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_ClosedLoopSystem(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_ClosedLoopSystem(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_ClosedLoopSystem(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_ClosedLoopSystem_method_dispatcher.\n"
