...
#include <stddef.h>
#include "blas.h"
#include "ClosedLoopSystem_sfun.h"
#include "c5_ClosedLoopSystem.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "ClosedLoopSystem_sfun_debug_macros.h"
...
static const char * c5_debug_family_names[8] = { "nargin", "nargout", "x", "y",
  "ksi", "Ux", "Uy", "x0" };

/* Function Declarations */
static void initialize_c5_ClosedLoopSystem(SFc5_ClosedLoopSystemInstanceStruct
  *chartInstance);
static void initialize_params_c5_ClosedLoopSystem
  (SFc5_ClosedLoopSystemInstanceStruct *chartInstance);
static void enable_c5_ClosedLoopSystem(SFc5_ClosedLoopSystemInstanceStruct
  *chartInstance);
static void disable_c5_ClosedLoopSystem(SFc5_ClosedLoopSystemInstanceStruct
  *chartInstance);
static void c5_update_debugger_state_c5_ClosedLoopSystem
  (SFc5_ClosedLoopSystemInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_ClosedLoopSystem
  (SFc5_ClosedLoopSystemInstanceStruct *chartInstance);
static void set_sim_state_c5_ClosedLoopSystem
  (SFc5_ClosedLoopSystemInstanceStruct *chartInstance, const mxArray *c5_st);
static void finalize_c5_ClosedLoopSystem(SFc5_ClosedLoopSystemInstanceStruct
  *chartInstance);
static void sf_gateway_c5_ClosedLoopSystem(SFc5_ClosedLoopSystemInstanceStruct
  *chartInstance);
static void initSimStructsc5_ClosedLoopSystem
  (SFc5_ClosedLoopSystemInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber, uint32_T c5_instanceNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static void c5_emlrt_marshallIn(SFc5_ClosedLoopSystemInstanceStruct
  *chartInstance, const mxArray *c5_x0, const char_T *c5_identifier, real_T
  c5_y[4]);
static void c5_b_emlrt_marshallIn(SFc5_ClosedLoopSystemInstanceStruct
...
static const mxArray *c5_b_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static real_T c5_c_emlrt_marshallIn(SFc5_ClosedLoopSystemInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
...
static real_T c5_mpower(SFc5_ClosedLoopSystemInstanceStruct *chartInstance,
  real_T c5_a);
static void c5_eml_scalar_eg(SFc5_ClosedLoopSystemInstanceStruct *chartInstance);
static void c5_eml_error(SFc5_ClosedLoopSystemInstanceStruct *chartInstance);
static const mxArray *c5_c_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_d_emlrt_marshallIn(SFc5_ClosedLoopSystemInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_e_emlrt_marshallIn(SFc5_ClosedLoopSystemInstanceStruct
  *chartInstance, const mxArray *c5_b_is_active_c5_ClosedLoopSystem, const
  char_T *c5_identifier);
static uint8_T c5_f_emlrt_marshallIn(SFc5_ClosedLoopSystemInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void init_dsm_address_info(SFc5_ClosedLoopSystemInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_ClosedLoopSystem = 0U;
}
  ...
  (SFc5_ClosedLoopSystemInstanceStruct *chartInstance, const mxArray *c5_st)
{
  ...
  c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 0)), "x0",
                      c5_dv0);
  for (c5_i1 = 0; c5_i1 < 4; c5_i1++) {
    (*c5_x0)[c5_i1] = c5_dv0[c5_i1];
  }

  chartInstance->c5_is_active_c5_ClosedLoopSystem = c5_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 1)),
     "is_active_c5_ClosedLoopSystem");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_ClosedLoopSystem(chartInstance);
  ...
  *chartInstance)
{
  ...
  real_T *c5_b_Uy;
  real_T (*c5_b_x0)[4];
  c5_b_x0 = (real_T (*)[4])ssGetOutputPortSignal(chartInstance->S, 1);
  c5_b_Uy = (real_T *)ssGetInputPortSignal(chartInstance->S, 4);
  c5_b_Ux = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c5_b_ksi = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  ...
  _SFD_DATA_RANGE_CHECK(*c5_b_ksi, 2U);
  _SFD_DATA_RANGE_CHECK(*c5_b_Ux, 3U);
  _SFD_DATA_RANGE_CHECK(*c5_b_Uy, 4U);
  chartInstance->c5_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 4U, chartInstance->c5_sfEvent);
  c5_hoistedGlobal = *c5_d_x;
  c5_b_hoistedGlobal = *c5_b_y;
  c5_c_hoistedGlobal = *c5_b_ksi;
  c5_d_hoistedGlobal = *c5_b_Ux;
  c5_e_hoistedGlobal = *c5_b_Uy;
  c5_x = c5_hoistedGlobal;
  c5_y = c5_b_hoistedGlobal;
  c5_ksi = c5_c_hoistedGlobal;
  c5_Ux = c5_d_hoistedGlobal;
  c5_Uy = c5_e_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_nargout, 1U, c5_b_sf_marshallOut,
    c5_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_x, 2U, c5_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_y, 3U, c5_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_ksi, 4U, c5_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_Ux, 5U, c5_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c5_Uy, 6U, c5_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c5_x0, 7U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c5_b_x = c5_mpower(chartInstance, c5_Ux) + c5_mpower(chartInstance, c5_Uy);
  c5_c_x = c5_b_x;
  if (c5_c_x < 0.0) {
  ...
  for (c5_i3 = 0; c5_i3 < 4; c5_i3++) {
    (*c5_b_x0)[c5_i3] = c5_x0[c5_i3];
  }

  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 4U, chartInstance->c5_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_ClosedLoopSystemMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  for (c5_i4 = 0; c5_i4 < 4; c5_i4++) {
    _SFD_DATA_RANGE_CHECK((*c5_b_x0)[c5_i4], 5U);
  }
}
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_ClosedLoopSystemInstanceStruct *chartInstance;
  chartInstance = (SFc5_ClosedLoopSystemInstanceStruct *)chartInstanceVoid;
  c5_mxArrayOutData = NULL;
  for (c5_i5 = 0; c5_i5 < 4; c5_i5++) {
    c5_b_inData[c5_i5] = (*(real_T (*)[4])c5_inData)[c5_i5];
  }
  ...
  c5_y[4])
{
  ...
  c5_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_x0), &c5_thisId, c5_y);
  sf_mex_destroy(&c5_x0);
}
  ...
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData)
{
  ...
  SFc5_ClosedLoopSystemInstanceStruct *chartInstance;
  chartInstance = (SFc5_ClosedLoopSystemInstanceStruct *)chartInstanceVoid;
  c5_x0 = sf_mex_dup(c5_mxArrayInData);
  ...
  for (c5_i8 = 0; c5_i8 < 4; c5_i8++) {
    (*(real_T (*)[4])c5_outData)[c5_i8] = c5_y[c5_i8];
  }
...
const mxArray *sf_c5_ClosedLoopSystem_get_eml_resolved_functions_info(void)
{
...
static void c5_info_helper(const mxArray **c5_info)
{
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("sqrt"), "name", "name", 13);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 13);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId)
{
  ...
  int32_T c5_i11;
  (void)chartInstance;
  sf_mex_import(c5_parentId, sf_mex_dup(c5_u), &c5_i11, 1, 6, 0U, 0, 0U, 0);
  c5_y = c5_i11;
  sf_mex_destroy(&c5_u);
  return c5_y;
}
  ...
  char_T *c5_identifier)
{
  ...
  c5_y = c5_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_ClosedLoopSystem), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_ClosedLoopSystem);
  return c5_y;
}
...
void sf_c5_ClosedLoopSystem_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2830882817U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1162473152U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(172682398U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3944930030U);
}

mxArray *sf_c5_ClosedLoopSystem_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("xF5pqpZLzSxhZdxWCJMYd");
...
mxArray *sf_c5_ClosedLoopSystem_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_ClosedLoopSystem_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c5_ClosedLoopSystem(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[9],T\"x0\",},{M[8],M[0],T\"is_active_c5_ClosedLoopSystem\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_ClosedLoopSystem_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc5_ClosedLoopSystemInstanceStruct *)
      ...
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (sfGlobalDebugInstanceStruct,
           _ClosedLoopSystemMachineNumber_,
           5,
           1,
           1,
           0,
        ...
        init_script_number_translation(_ClosedLoopSystemMachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_ClosedLoopSystemMachineNumber_,
          ...
          _SFD_SET_DATA_PROPS(2,1,1,0,"ksi");
          _SFD_SET_DATA_PROPS(3,1,1,0,"Ux");
          _SFD_SET_DATA_PROPS(4,1,1,0,"Uy");
...

        {
          ...
          real_T (*c5_x0)[4];
          c5_x0 = (real_T (*)[4])ssGetOutputPortSignal(chartInstance->S, 1);
          c5_Uy = (real_T *)ssGetInputPortSignal(chartInstance->S, 4);
          c5_Ux = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
          c5_ksi = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
          ...
          _SFD_SET_DATA_VALUE_PTR(2U, c5_ksi);
          _SFD_SET_DATA_VALUE_PTR(3U, c5_Ux);
          _SFD_SET_DATA_VALUE_PTR(4U, c5_Uy);
          _SFD_SET_DATA_VALUE_PTR(5U, *c5_x0);
        }
      }
    } else {
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _ClosedLoopSystemMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "SdxQ3qySqojHKtCyywOhtG";
}

static void sf_opaque_initialize_c5_ClosedLoopSystem(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_ClosedLoopSystemInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c5_ClosedLoopSystem((SFc5_ClosedLoopSystemInstanceStruct*)
    chartInstanceVar);
  initialize_c5_ClosedLoopSystem((SFc5_ClosedLoopSystemInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c5_ClosedLoopSystem(void *chartInstanceVar)
{
  enable_c5_ClosedLoopSystem((SFc5_ClosedLoopSystemInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c5_ClosedLoopSystem(void *chartInstanceVar)
{
  disable_c5_ClosedLoopSystem((SFc5_ClosedLoopSystemInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c5_ClosedLoopSystem(void *chartInstanceVar)
{
  sf_gateway_c5_ClosedLoopSystem((SFc5_ClosedLoopSystemInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c5_ClosedLoopSystem(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_ClosedLoopSystem
    ((SFc5_ClosedLoopSystemInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_ClosedLoopSystem();/* state var info */
...
extern void sf_internal_set_sim_state_c5_ClosedLoopSystem(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c5_ClosedLoopSystem();/* state var info */
  ...
  set_sim_state_c5_ClosedLoopSystem((SFc5_ClosedLoopSystemInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_ClosedLoopSystem(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_ClosedLoopSystem(S);
}

static void sf_opaque_set_sim_state_c5_ClosedLoopSystem(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c5_ClosedLoopSystem(S, st);
}

static void sf_opaque_terminate_c5_ClosedLoopSystem(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_ClosedLoopSystemInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_ClosedLoopSystem_optimization_info();
    }

    finalize_c5_ClosedLoopSystem((SFc5_ClosedLoopSystemInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc5_ClosedLoopSystem((SFc5_ClosedLoopSystemInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_ClosedLoopSystem(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_ClosedLoopSystem(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_ClosedLoopSystem_optimization_info();
  ...
  ssSetChecksum0(S,(2096185533U));
  ssSetChecksum1(S,(3735651518U));
  ssSetChecksum2(S,(1008981527U));
  ssSetChecksum3(S,(2956469252U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c5_ClosedLoopSystem(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_ClosedLoopSystem(SimStruct *S)
{
  SFc5_ClosedLoopSystemInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc5_ClosedLoopSystemInstanceStruct *)utMalloc(sizeof
    (SFc5_ClosedLoopSystemInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_ClosedLoopSystemInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_ClosedLoopSystem;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_ClosedLoopSystem;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_ClosedLoopSystem;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_ClosedLoopSystem;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_ClosedLoopSystem;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_ClosedLoopSystem;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_ClosedLoopSystem;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_ClosedLoopSystem;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_ClosedLoopSystem;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_ClosedLoopSystem;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_ClosedLoopSystem;
...
void c5_ClosedLoopSystem_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_ClosedLoopSystem(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_ClosedLoopSystem(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_ClosedLoopSystem(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_ClosedLoopSystem_method_dispatcher.\n"
