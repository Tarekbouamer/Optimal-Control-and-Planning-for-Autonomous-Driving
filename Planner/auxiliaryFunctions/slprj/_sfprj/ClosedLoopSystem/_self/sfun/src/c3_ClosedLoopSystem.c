...
static void initialize_c3_ClosedLoopSystem(SFc3_ClosedLoopSystemInstanceStruct
  *chartInstance);
static void initialize_params_c3_ClosedLoopSystem
  (SFc3_ClosedLoopSystemInstanceStruct *chartInstance);
static void enable_c3_ClosedLoopSystem(SFc3_ClosedLoopSystemInstanceStruct
  *chartInstance);
static void disable_c3_ClosedLoopSystem(SFc3_ClosedLoopSystemInstanceStruct
  *chartInstance);
static void c3_update_debugger_state_c3_ClosedLoopSystem
  (SFc3_ClosedLoopSystemInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_ClosedLoopSystem
  (SFc3_ClosedLoopSystemInstanceStruct *chartInstance);
static void set_sim_state_c3_ClosedLoopSystem
  (SFc3_ClosedLoopSystemInstanceStruct *chartInstance, const mxArray *c3_st);
static void finalize_c3_ClosedLoopSystem(SFc3_ClosedLoopSystemInstanceStruct
  *chartInstance);
static void sf_gateway_c3_ClosedLoopSystem(SFc3_ClosedLoopSystemInstanceStruct
  *chartInstance);
static void c3_chartstep_c3_ClosedLoopSystem(SFc3_ClosedLoopSystemInstanceStruct
  *chartInstance);
static void initSimStructsc3_ClosedLoopSystem
  (SFc3_ClosedLoopSystemInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_ClosedLoopSystemInstanceStruct
  *chartInstance, const mxArray *c3_xhb, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_ClosedLoopSystemInstanceStruct
...
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_c_emlrt_marshallIn(SFc3_ClosedLoopSystemInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static void c3_d_emlrt_marshallIn(SFc3_ClosedLoopSystemInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  c3_snXp3ygPcVyeDzfVLtVbyQF *c3_y);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_e_emlrt_marshallIn(SFc3_ClosedLoopSystemInstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_ClosedLoopSystem, const
  char_T *c3_identifier);
static uint8_T c3_f_emlrt_marshallIn(SFc3_ClosedLoopSystemInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_ClosedLoopSystemInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_ClosedLoopSystem = 0U;
}
  ...
  (SFc3_ClosedLoopSystemInstanceStruct *chartInstance)
{
  ...
  c3_c_hoistedGlobal = chartInstance->c3_is_active_c3_ClosedLoopSystem;
  ...
  (SFc3_ClosedLoopSystemInstanceStruct *chartInstance, const mxArray *c3_st)
{
  ...
  *c3_xhb = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 1)),
    "xhb");
  chartInstance->c3_is_active_c3_ClosedLoopSystem = c3_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 2)),
     "is_active_c3_ClosedLoopSystem");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_ClosedLoopSystem(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_ClosedLoopSystem(chartInstance);
  ...
  *chartInstance)
{
  ...
  real_T c3_xb;
  real_T c3_xhb;
  static c3_snXp3ygPcVyeDzfVLtVbyQF c3_r1 = { 1245.0, 1200.0, 1.8, 1.1, 1.3,
  ...
  c3_c_A = -(1.8 * c3_derF + c3_FxF * 0.29);
  c3_g_x = c3_c_A;
  c3_h_x = c3_g_x;
  c3_i_x = c3_h_x;
  c3_y = c3_i_x / 0.6;
  ...
  c3_e_A = -((1.8 * c3_derR + c3_FxR * 0.29) + 0.4 * c3_xb * 3000.0);
  c3_m_x = c3_e_A;
  c3_n_x = c3_m_x;
  c3_o_x = c3_n_x;
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_ClosedLoopSystemInstanceStruct *chartInstance;
  chartInstance = (SFc3_ClosedLoopSystemInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_ClosedLoopSystem_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c3_identifier)
{
  ...
  c3_y = c3_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_ClosedLoopSystem), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_ClosedLoopSystem);
  return c3_y;
}
...
void sf_c3_ClosedLoopSystem_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3235862995U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3050147023U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2052466587U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3519127618U);
}

mxArray *sf_c3_ClosedLoopSystem_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("930BOsEHC9acNOMtCookXH");
...
mxArray *sf_c3_ClosedLoopSystem_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_ClosedLoopSystem_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_ClosedLoopSystem(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"xb\",},{M[1],M[14],T\"xhb\",},{M[8],M[0],T\"is_active_c3_ClosedLoopSystem\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_ClosedLoopSystem_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_ClosedLoopSystemInstanceStruct *)
...
{
  return "doz4jEVwA9gOeYUi4jXorE";
}

static void sf_opaque_initialize_c3_ClosedLoopSystem(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_ClosedLoopSystemInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_ClosedLoopSystem((SFc3_ClosedLoopSystemInstanceStruct*)
    chartInstanceVar);
  initialize_c3_ClosedLoopSystem((SFc3_ClosedLoopSystemInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_ClosedLoopSystem(void *chartInstanceVar)
{
  enable_c3_ClosedLoopSystem((SFc3_ClosedLoopSystemInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c3_ClosedLoopSystem(void *chartInstanceVar)
{
  disable_c3_ClosedLoopSystem((SFc3_ClosedLoopSystemInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_ClosedLoopSystem(void *chartInstanceVar)
{
  sf_gateway_c3_ClosedLoopSystem((SFc3_ClosedLoopSystemInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_ClosedLoopSystem(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_ClosedLoopSystem
    ((SFc3_ClosedLoopSystemInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_ClosedLoopSystem();/* state var info */
...
extern void sf_internal_set_sim_state_c3_ClosedLoopSystem(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c3_ClosedLoopSystem();/* state var info */
  ...
  set_sim_state_c3_ClosedLoopSystem((SFc3_ClosedLoopSystemInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_ClosedLoopSystem(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_ClosedLoopSystem(S);
}

static void sf_opaque_set_sim_state_c3_ClosedLoopSystem(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c3_ClosedLoopSystem(S, st);
}

static void sf_opaque_terminate_c3_ClosedLoopSystem(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_ClosedLoopSystemInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_ClosedLoopSystem((SFc3_ClosedLoopSystemInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc3_ClosedLoopSystem((SFc3_ClosedLoopSystemInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_ClosedLoopSystem(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_ClosedLoopSystem(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1906544617U));
  ssSetChecksum1(S,(2670775420U));
  ssSetChecksum2(S,(3249798385U));
  ssSetChecksum3(S,(3915082492U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c3_ClosedLoopSystem(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_ClosedLoopSystem(SimStruct *S)
{
  SFc3_ClosedLoopSystemInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_ClosedLoopSystemInstanceStruct *)utMalloc(sizeof
    (SFc3_ClosedLoopSystemInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_ClosedLoopSystemInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_ClosedLoopSystem;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_ClosedLoopSystem;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_ClosedLoopSystem;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_ClosedLoopSystem;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_ClosedLoopSystem;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_ClosedLoopSystem;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_ClosedLoopSystem;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_ClosedLoopSystem;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_ClosedLoopSystem;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_ClosedLoopSystem;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_ClosedLoopSystem;
...
void c3_ClosedLoopSystem_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_ClosedLoopSystem(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_ClosedLoopSystem(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_ClosedLoopSystem(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_ClosedLoopSystem_method_dispatcher.\n"
