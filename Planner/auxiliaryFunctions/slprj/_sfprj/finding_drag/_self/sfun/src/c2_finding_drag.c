...
static void initialize_c2_finding_drag(SFc2_finding_dragInstanceStruct
  *chartInstance);
static void initialize_params_c2_finding_drag(SFc2_finding_dragInstanceStruct
  *chartInstance);
static void enable_c2_finding_drag(SFc2_finding_dragInstanceStruct
  *chartInstance);
static void disable_c2_finding_drag(SFc2_finding_dragInstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_finding_drag
  (SFc2_finding_dragInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_finding_drag
  (SFc2_finding_dragInstanceStruct *chartInstance);
static void set_sim_state_c2_finding_drag(SFc2_finding_dragInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_finding_drag(SFc2_finding_dragInstanceStruct
  *chartInstance);
static void sf_gateway_c2_finding_drag(SFc2_finding_dragInstanceStruct
  *chartInstance);
static void c2_chartstep_c2_finding_drag(SFc2_finding_dragInstanceStruct
  *chartInstance);
static void initSimStructsc2_finding_drag(SFc2_finding_dragInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_finding_dragInstanceStruct *chartInstance,
  const mxArray *c2_FyR, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_finding_dragInstanceStruct
...
static real_T c2_robustDiv2(SFc2_finding_dragInstanceStruct *chartInstance,
  real_T c2_num, real_T c2_den, real_T c2_epsilon);
static real_T c2_mpower(SFc2_finding_dragInstanceStruct *chartInstance, real_T
  c2_a);
static void c2_eml_scalar_eg(SFc2_finding_dragInstanceStruct *chartInstance);
static void c2_eml_error(SFc2_finding_dragInstanceStruct *chartInstance);
static real_T c2_robustDiv(SFc2_finding_dragInstanceStruct *chartInstance,
  real_T c2_num, real_T c2_den, real_T c2_epsilon);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_c_emlrt_marshallIn(SFc2_finding_dragInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_d_emlrt_marshallIn(SFc2_finding_dragInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  c2_snXp3ygPcVyeDzfVLtVbyQF *c2_y);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_e_emlrt_marshallIn(SFc2_finding_dragInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_finding_drag, const char_T
  *c2_identifier);
static uint8_T c2_f_emlrt_marshallIn(SFc2_finding_dragInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_finding_dragInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_finding_drag = 0U;
}
  ...
  (SFc2_finding_dragInstanceStruct *chartInstance)
{
  ...
  c2_e_hoistedGlobal = chartInstance->c2_is_active_c2_finding_drag;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  *c2_FyR = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 3)),
    "FyR");
  chartInstance->c2_is_active_c2_finding_drag = c2_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 4)),
     "is_active_c2_finding_drag");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_finding_drag(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_finding_drag(chartInstance);
  ...
  *chartInstance)
{
  ...
  real_T c2_FxR;
  real_T c2_FyR;
  static c2_snXp3ygPcVyeDzfVLtVbyQF c2_r1 = { 1270.0, 1200.0, 1.8, 1.015, 1.895,
  ...
  c2_num = 23609.236500000003 - 5382.1584000000012 * c2_muxR;
  ...
  c2_den = 2.91 + 0.43200000000000005 * ((c2_muxF * c2_ab_x - c2_muyF * c2_cb_x)
    - c2_muxR);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_finding_dragInstanceStruct *chartInstance;
  chartInstance = (SFc2_finding_dragInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_finding_drag_get_eml_resolved_functions_info(void)
{
  ...
  *c2_identifier)
{
  ...
  c2_y = c2_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_finding_drag), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_finding_drag);
  return c2_y;
}
...
void sf_c2_finding_drag_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4267644445U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3406460009U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1598826179U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4159386051U);
}

mxArray *sf_c2_finding_drag_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("f7OURapNB7XEs5KX6APmmG");
...
mxArray *sf_c2_finding_drag_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_finding_drag_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_finding_drag(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[5],T\"FxF\",},{M[1],M[21],T\"FxR\",},{M[1],M[20],T\"FyF\",},{M[1],M[22],T\"FyR\",},{M[8],M[0],T\"is_active_c2_finding_drag\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_finding_drag_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_finding_dragInstanceStruct *) chartInfo->chartInstance;
...
{
  return "keHE0RgTOHKZ1WrdGrlCy";
}

static void sf_opaque_initialize_c2_finding_drag(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_finding_dragInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_finding_drag((SFc2_finding_dragInstanceStruct*)
    chartInstanceVar);
  initialize_c2_finding_drag((SFc2_finding_dragInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_finding_drag(void *chartInstanceVar)
{
  enable_c2_finding_drag((SFc2_finding_dragInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_finding_drag(void *chartInstanceVar)
{
  disable_c2_finding_drag((SFc2_finding_dragInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_finding_drag(void *chartInstanceVar)
{
  sf_gateway_c2_finding_drag((SFc2_finding_dragInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_finding_drag(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_finding_drag
    ((SFc2_finding_dragInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_finding_drag();/* state var info */
...
extern void sf_internal_set_sim_state_c2_finding_drag(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_finding_drag();/* state var info */
  ...
  set_sim_state_c2_finding_drag((SFc2_finding_dragInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_finding_drag(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_finding_drag(S);
}

static void sf_opaque_set_sim_state_c2_finding_drag(SimStruct* S, const mxArray *
  st)
{
  sf_internal_set_sim_state_c2_finding_drag(S, st);
}

static void sf_opaque_terminate_c2_finding_drag(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_finding_dragInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_finding_drag((SFc2_finding_dragInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_finding_drag((SFc2_finding_dragInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_finding_drag(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_finding_drag(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1907232825U));
  ssSetChecksum1(S,(2211143199U));
  ssSetChecksum2(S,(425161952U));
  ssSetChecksum3(S,(774438706U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_finding_drag(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_finding_drag(SimStruct *S)
{
  SFc2_finding_dragInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_finding_dragInstanceStruct *)utMalloc(sizeof
    (SFc2_finding_dragInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_finding_dragInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_finding_drag;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_finding_drag;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_finding_drag;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_finding_drag;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_finding_drag;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_finding_drag;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_finding_drag;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_finding_drag;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_finding_drag;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_finding_drag;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_finding_drag;
...
void c2_finding_drag_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_finding_drag(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_finding_drag(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_finding_drag(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_finding_drag_method_dispatcher.\n"
