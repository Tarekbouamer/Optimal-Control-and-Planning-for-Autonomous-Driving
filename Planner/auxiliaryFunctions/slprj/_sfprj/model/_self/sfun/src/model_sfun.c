  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1365197550U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2714110003U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2412498189U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1254407501U);
  }
  ...
  const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(aiChksum, "i3sJkI3phnw3yRrAYA3d2F") == 0) {
     ...
     case 2:
      {
        if (strcmp(aiChksum, "f0AtmexA08dhLCscepHxHD") == 0) {
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "9YIKs2VnmGFTZc7Hq5N7nG") == 0) {
     ...
     case 2:
      {
        if (strcmp(tpChksum, "tVyL23ll6dokSpwJgEjSPD") == 0) {
