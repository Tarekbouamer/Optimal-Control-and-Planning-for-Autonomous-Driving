...
static const char * c1_debug_family_names[13] = { "pressF", "pressR", "params",
  "nargin", "nargout", "FxF", "FxR", "wF", "wR", "masterPress", "handbrakeCmd",
  "TbF", "TbR" };
...
static real_T c1_emlrt_marshallIn(SFc1_modelInstanceStruct *chartInstance, const
  mxArray *c1_TbR, const char_T *c1_identifier);
...
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_d_emlrt_marshallIn(SFc1_modelInstanceStruct *chartInstance, const
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  c1_sTXaXgTBgcsTeEwtC20RoaB *c1_y);
...
static void initialize_params_c1_model(SFc1_modelInstanceStruct *chartInstance)
{
  ...
  c1_sTXaXgTBgcsTeEwtC20RoaB c1_r0;
  ...
  sf_mex_import_named("params", sf_mex_dup(c1_mxField), &c1_r0.b, 1, 0, 0U, 0,
                      0U, 0);
  c1_mxField = sf_mex_getfield(c1_m0, "fric", "params", 0);
  sf_mex_import_named("params", sf_mex_dup(c1_mxField), &c1_r0.fric, 1, 0, 0U, 0,
                      0U, 0);
  ...
  sf_mex_import_named("params", sf_mex_dup(c1_mxField), &c1_r0.ksi0, 1, 0, 0U, 0,
                      0U, 0);
  c1_mxField = sf_mex_getfield(c1_m0, "Press2TorF", "params", 0);
  sf_mex_import_named("params", sf_mex_dup(c1_mxField), &c1_r0.Press2TorF, 1, 0,
                      0U, 0, 0U, 0);
  c1_mxField = sf_mex_getfield(c1_m0, "Press2TorR", "params", 0);
  sf_mex_import_named("params", sf_mex_dup(c1_mxField), &c1_r0.Press2TorR, 1, 0,
                      0U, 0, 0U, 0);
  c1_mxField = sf_mex_getfield(c1_m0, "maxPress", "params", 0);
  sf_mex_import_named("params", sf_mex_dup(c1_mxField), &c1_r0.maxPress, 1, 0,
                      0U, 0, 0U, 0);
  c1_mxField = sf_mex_getfield(c1_m0, "press2torF", "params", 0);
  sf_mex_import_named("params", sf_mex_dup(c1_mxField), &c1_r0.press2torF, 1, 0,
                      0U, 0, 0U, 0);
  ...
  *chartInstance)
{
  ...
  c1_c_hoistedGlobal = chartInstance->c1_is_active_c1_model;
  ...
  const mxArray *c1_st)
{
  ...
  *c1_TbR = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
  ...
  chartInstance->c1_is_active_c1_model = c1_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 2)), "is_active_c1_model");
  sf_mex_destroy(&c1_u);
...
static void sf_gateway_c1_model(SFc1_modelInstanceStruct *chartInstance)
{
  ...
  real_T c1_wF;
  real_T c1_wR;
  real_T c1_masterPress;
  real_T c1_handbrakeCmd;
  uint32_T c1_debug_family_var_map[13];
  real_T c1_pressF;
  real_T c1_pressR;
  c1_sTXaXgTBgcsTeEwtC20RoaB c1_b_params;
  real_T c1_nargin = 7.0;
  real_T c1_nargout = 2.0;
  real_T c1_TbF;
  real_T c1_TbR;
  static c1_sTXaXgTBgcsTeEwtC20RoaB c1_r1 = { 1270.0, 1200.0, 1.8, 1.015, 1.895,
  ...
  real_T *c1_b_wF;
  real_T *c1_b_wR;
  real_T *c1_b_masterPress;
  real_T *c1_b_handbrakeCmd;
  real_T *c1_b_TbR;
  c1_b_TbR = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c1_b_handbrakeCmd = (real_T *)ssGetInputPortSignal(chartInstance->S, 5);
  c1_b_masterPress = (real_T *)ssGetInputPortSignal(chartInstance->S, 4);
  ...
  c1_e_hoistedGlobal = *c1_b_masterPress;
  c1_f_hoistedGlobal = *c1_b_handbrakeCmd;
  c1_FxF = c1_hoistedGlobal;
  c1_FxR = c1_b_hoistedGlobal;
  c1_wF = c1_c_hoistedGlobal;
  c1_wR = c1_d_hoistedGlobal;
  c1_masterPress = c1_e_hoistedGlobal;
  c1_handbrakeCmd = c1_f_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 13U, 13U, c1_debug_family_names,
    c1_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_pressF, 0U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_pressR, 1U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_b_params, 2U, c1_b_sf_marshallOut);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_nargout, 4U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_FxF, 5U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_FxR, 6U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_wF, 7U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_wR, 8U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_masterPress, 9U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_handbrakeCmd, 10U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_TbF, 11U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_TbR, 12U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  c1_b_params = c1_r1;
  CV_EML_FCN(0, 0);
  ...
  c1_pressF = c1_masterPress;
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 7);
  if (CV_EML_IF(0, 1, 0, c1_masterPress <= 1.5)) {
    _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 8);
    c1_pressR = c1_masterPress;
  } else {
    _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 10);
    c1_pressR = 0.3 * c1_masterPress + 1.05;
  }

  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 13);
  if (CV_EML_IF(0, 1, 1, c1_masterPress > 0.0)) {
    _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 15);
    if (CV_EML_IF(0, 1, 2, c1_wF != 0.0)) {
      _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 16);
      c1_x = c1_wF;
      c1_b_x = c1_x;
      c1_b_x = muDoubleScalarSign(c1_b_x);
      c1_TbF = -c1_pressF * 250.0 * c1_b_x;
    } else {
    ...
    if (CV_EML_IF(0, 1, 3, c1_wR != 0.0)) {
      _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 22);
      c1_c_x = c1_wR;
      c1_d_x = c1_c_x;
      c1_d_x = muDoubleScalarSign(c1_d_x);
      c1_TbR -= c1_pressR * 150.0 * c1_d_x;
    } else {
  ...
  if (CV_EML_IF(0, 1, 4, c1_handbrakeCmd > 0.0)) {
    _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 30);
    if (CV_EML_IF(0, 1, 5, c1_wR != 0.0)) {
      _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 31);
      c1_e_x = c1_wR;
      c1_f_x = c1_e_x;
      c1_f_x = muDoubleScalarSign(c1_f_x);
      c1_TbR -= c1_handbrakeCmd * 1000.0 * c1_f_x;
    } else {
  ...
  *c1_b_TbR = c1_TbR;
  ...
  _SFD_DATA_RANGE_CHECK(*c1_b_masterPress, 6U);
  _SFD_DATA_RANGE_CHECK(*c1_b_handbrakeCmd, 7U);
...
{
  const mxArray *c1_mxArrayOutData = NULL;
  c1_sTXaXgTBgcsTeEwtC20RoaB c1_u;
  const mxArray *c1_y = NULL;
  real_T c1_b_u;
  const mxArray *c1_b_y = NULL;
  real_T c1_c_u;
  ...
  chartInstance = (SFc1_modelInstanceStruct *)chartInstanceVoid;
  c1_mxArrayOutData = NULL;
  c1_u = *(c1_sTXaXgTBgcsTeEwtC20RoaB *)c1_inData;
  c1_y = NULL;
...
{
  emlrtMsgIdentifier c1_thisId;
  static const char * c1_fieldNames[38] = { "m", "Iz", "Iw", "lF", "lR", "h",
  ...
  sf_mex_check_struct(c1_parentId, c1_u, 38, c1_fieldNames, 0U, NULL);
  ...
  c1_y->b = c1_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield(c1_u,
    "b", "b", 0)), &c1_thisId);
  c1_thisId.fIdentifier = "fric";
  c1_y->fric = c1_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c1_u, "fric", "fric", 0)), &c1_thisId);
  ...
  c1_thisId.fIdentifier = "Press2TorF";
  c1_y->Press2TorF = c1_b_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getfield(c1_u, "Press2TorF", "Press2TorF", 0)), &c1_thisId);
  c1_thisId.fIdentifier = "Press2TorR";
  c1_y->Press2TorR = c1_b_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getfield(c1_u, "Press2TorR", "Press2TorR", 0)), &c1_thisId);
  c1_thisId.fIdentifier = "maxPress";
  c1_y->maxPress = c1_b_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getfield(c1_u, "maxPress", "maxPress", 0)), &c1_thisId);
  c1_thisId.fIdentifier = "press2torF";
  c1_y->press2torF = c1_b_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getfield(c1_u, "press2torF", "press2torF", 0)), &c1_thisId);
  c1_thisId.fIdentifier = "press2torR";
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  *(c1_sTXaXgTBgcsTeEwtC20RoaB *)c1_outData = c1_y;
  sf_mex_destroy(&c1_mxArrayInData);
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2633157836U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1466945488U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2307398685U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3986693334U);
}
...
mxArray *sf_c1_model_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("i3sJkI3phnw3yRrAYA3d2F");
...
static const mxArray *sf_get_sim_state_info_c1_model(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"TbF\",},{M[1],M[11],T\"TbR\",},{M[8],M[0],T\"is_active_c1_model\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(6,1,1,0,"masterPress");
          _SFD_SET_DATA_PROPS(7,1,1,0,"handbrakeCmd");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,660);
        _SFD_CV_INIT_EML_IF(0,1,0,129,150,177,223);
        _SFD_CV_INIT_EML_IF(0,1,1,229,247,-1,498);
        _SFD_CV_INIT_EML_IF(0,1,2,256,266,326,368);
        _SFD_CV_INIT_EML_IF(0,1,3,378,388,452,494);
        _SFD_CV_INIT_EML_IF(0,1,4,500,519,-1,653);
        _SFD_CV_INIT_EML_IF(0,1,5,528,538,604,646);
...

        {
          ...
          real_T *c1_TbR;
          c1_TbR = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
          c1_handbrakeCmd = (real_T *)ssGetInputPortSignal(chartInstance->S, 5);
          c1_masterPress = (real_T *)ssGetInputPortSignal(chartInstance->S, 4);
          ...
          _SFD_SET_DATA_VALUE_PTR(6U, c1_masterPress);
          _SFD_SET_DATA_VALUE_PTR(7U, c1_handbrakeCmd);
...
static void mdlSetWorkWidths_c1_model(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(453804931U));
  ssSetChecksum1(S,(1267068564U));
  ssSetChecksum2(S,(1365615977U));
  ssSetChecksum3(S,(794406965U));
