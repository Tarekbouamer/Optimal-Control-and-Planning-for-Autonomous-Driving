...
static real_T c3_emlrt_marshallIn(SFc3_modelInstanceStruct *chartInstance, const
  mxArray *c3_xhb, const char_T *c3_identifier);
...
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static void c3_d_emlrt_marshallIn(SFc3_modelInstanceStruct *chartInstance, const
  mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  c3_sTXaXgTBgcsTeEwtC20RoaB *c3_y);
...
static void initialize_params_c3_model(SFc3_modelInstanceStruct *chartInstance)
{
  ...
  c3_sTXaXgTBgcsTeEwtC20RoaB c3_r0;
  ...
  sf_mex_import_named("params", sf_mex_dup(c3_mxField), &c3_r0.b, 1, 0, 0U, 0,
                      0U, 0);
  c3_mxField = sf_mex_getfield(c3_m0, "fric", "params", 0);
  sf_mex_import_named("params", sf_mex_dup(c3_mxField), &c3_r0.fric, 1, 0, 0U, 0,
                      0U, 0);
  ...
  sf_mex_import_named("params", sf_mex_dup(c3_mxField), &c3_r0.ksi0, 1, 0, 0U, 0,
                      0U, 0);
  c3_mxField = sf_mex_getfield(c3_m0, "Press2TorF", "params", 0);
  sf_mex_import_named("params", sf_mex_dup(c3_mxField), &c3_r0.Press2TorF, 1, 0,
                      0U, 0, 0U, 0);
  c3_mxField = sf_mex_getfield(c3_m0, "Press2TorR", "params", 0);
  sf_mex_import_named("params", sf_mex_dup(c3_mxField), &c3_r0.Press2TorR, 1, 0,
                      0U, 0, 0U, 0);
  c3_mxField = sf_mex_getfield(c3_m0, "maxPress", "params", 0);
  sf_mex_import_named("params", sf_mex_dup(c3_mxField), &c3_r0.maxPress, 1, 0,
                      0U, 0, 0U, 0);
  c3_mxField = sf_mex_getfield(c3_m0, "press2torF", "params", 0);
  sf_mex_import_named("params", sf_mex_dup(c3_mxField), &c3_r0.press2torF, 1, 0,
                      0U, 0, 0U, 0);
  ...
  *chartInstance)
{
  ...
  c3_c_hoistedGlobal = chartInstance->c3_is_active_c3_model;
  ...
  const mxArray *c3_st)
{
  ...
  *c3_xhb = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 1)),
  ...
  chartInstance->c3_is_active_c3_model = c3_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 2)), "is_active_c3_model");
  sf_mex_destroy(&c3_u);
...
static void c3_chartstep_c3_model(SFc3_modelInstanceStruct *chartInstance)
{
  ...
  real_T c3_derF;
  real_T c3_derR;
  c3_sTXaXgTBgcsTeEwtC20RoaB c3_b_params;
  real_T c3_nargin = 9.0;
  real_T c3_nargout = 2.0;
  real_T c3_xb;
  real_T c3_xhb;
  static c3_sTXaXgTBgcsTeEwtC20RoaB c3_r1 = { 1270.0, 1200.0, 1.8, 1.015, 1.895,
...
{
  const mxArray *c3_mxArrayOutData = NULL;
  c3_sTXaXgTBgcsTeEwtC20RoaB c3_u;
  const mxArray *c3_y = NULL;
  real_T c3_b_u;
  const mxArray *c3_b_y = NULL;
  real_T c3_c_u;
  ...
  chartInstance = (SFc3_modelInstanceStruct *)chartInstanceVoid;
  c3_mxArrayOutData = NULL;
  c3_u = *(c3_sTXaXgTBgcsTeEwtC20RoaB *)c3_inData;
  c3_y = NULL;
...
{
  emlrtMsgIdentifier c3_thisId;
  static const char * c3_fieldNames[38] = { "m", "Iz", "Iw", "lF", "lR", "h",
  ...
  sf_mex_check_struct(c3_parentId, c3_u, 38, c3_fieldNames, 0U, NULL);
  ...
  c3_y->b = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield(c3_u,
    "b", "b", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "fric";
  c3_y->fric = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "fric", "fric", 0)), &c3_thisId);
  ...
  c3_thisId.fIdentifier = "Press2TorF";
  c3_y->Press2TorF = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getfield(c3_u, "Press2TorF", "Press2TorF", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "Press2TorR";
  c3_y->Press2TorR = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getfield(c3_u, "Press2TorR", "Press2TorR", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "maxPress";
  c3_y->maxPress = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getfield(c3_u, "maxPress", "maxPress", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "press2torF";
  c3_y->press2torF = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getfield(c3_u, "press2torF", "press2torF", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "press2torR";
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  *(c3_sTXaXgTBgcsTeEwtC20RoaB *)c3_outData = c3_y;
  sf_mex_destroy(&c3_mxArrayInData);
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1820602529U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(464588848U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(8809587U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(890276288U);
}
...
mxArray *sf_c3_model_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("qxEtF7wjvmQnjtJdX0yguE");
...
static const mxArray *sf_get_sim_state_info_c3_model(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"xb\",},{M[1],M[14],T\"xhb\",},{M[8],M[0],T\"is_active_c3_model\",}}"
  };
...
static void mdlSetWorkWidths_c3_model(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2801235783U));
  ssSetChecksum1(S,(4279997888U));
  ssSetChecksum2(S,(1001837802U));
  ssSetChecksum3(S,(1353838476U));
