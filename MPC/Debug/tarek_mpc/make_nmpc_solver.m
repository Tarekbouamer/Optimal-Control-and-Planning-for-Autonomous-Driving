...
function make_nmpc_solver( name )
	...
	CGSources = [ ...
		'CGRoot/nmpc_solver_mex.c ' ...
		'CGRoot/nmpc_solver.c ' ...
		'CGRoot/nmpc_integrator.c ' ...
		'CGRoot/nmpc_auxiliary_functions.c ' ...
		'CGRoot/nmpc_qpoases_interface.cpp ' ...
		];
	if (nargin > 1)
	...
	CGRecipe = [ ...
		...
		' ldFlags' ...
		' -D__MATLAB__ -DQPOASES_CUSTOM_INTERFACE="nmpc_qpoases_interface.hpp" -O CGSources qpOASESSources -output %s.%s' ...
		];
