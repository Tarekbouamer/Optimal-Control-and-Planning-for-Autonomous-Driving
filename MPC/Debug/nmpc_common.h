 ...
 * 
 *  Matrix containing 80 reference/measurement vectors of size 8 for first 80 nodes.
 */
real_t y[ 640 ];
...
/** Matrix of size: 480 x 2 (row major format) */
real_t evGu[ 960 ];
...
/** Matrix of size: 480 x 8 (row major format) */
real_t Q2[ 3840 ];
...
/** Matrix of size: 19440 x 2 (row major format) */
real_t E[ 38880 ];
